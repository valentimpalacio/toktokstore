...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    setLoading(true);
    try {
      await login('admin@toktokstore.com', 'admin123');
    ...
    <div className="container min-h-[85vh] flex-center">
      ...
      >
        ...
        <div className="mt-6 p-4 rounded-2xl border border-primary/20 bg-primary/5">
          <p className="text-xs font-bold text-primary mb-2 text-center">🔑 Demo Admin Account</p>
          <div className="flex items-center justify-between gap-2 text-sm">
            <div className="flex-1">
              <span className="text-text-muted text-xs">Email:</span>
              <p className="font-mono text-white">admin@toktokstore.com</p>
            </div>
            <div className="flex-1">
              <span className="text-text-muted text-xs">Senha:</span>
